...
2. Configure production SMTP and verify real confirmation and password-recovery delivery. Add tested signup abuse controls and provider spend alerts before broad signup.
