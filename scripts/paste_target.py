...
Abre una ventana con un cuadro de texto enfocado, espera a que Dictámelo pegue algo, guarda el
...
root = tk.Tk()
root.title("Dictámelo — destino de pegado (prueba automática)")
root.geometry("680x220+240+240")
label = tk.Label(root, text="Esta ventana la abrió la prueba automática de Dictámelo; se cerrará sola.")
